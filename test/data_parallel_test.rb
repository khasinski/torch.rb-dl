...
class DataParallelTest < Minitest::Test
  def test_scatter_cpu
    ...
    scattered = TorchDL.scatter(input, devices, 0)
  ...
  def test_scatter_dim1
    ...
    scattered = TorchDL.scatter(input, devices, 1)
  ...
  def test_gather_cpu
    ...
    gathered = TorchDL.gather([t1, t2], "cpu", 0)
  ...
  def test_gather_dim1
    ...
    gathered = TorchDL.gather([t1, t2], "cpu", 1)
  ...
  def test_scatter_gather_roundtrip
    ...
    scattered = TorchDL.scatter(input, devices, 0)
    gathered = TorchDL.gather(scattered, "cpu", 0)
  ...
  def test_gather_cuda
    ...
    gathered = TorchDL.gather([t1, t2], "cuda:0", 0)
  ...
  def test_data_parallel_backward_single_gpu
    ...
    model = Torch::NN::Linear.new(10, 5).to("cuda:0")
    dp_model = DataParallel.new(model, device_ids: [0])
  ...
  def test_data_parallel_with_loss_returning_model
    ...
    dp_model = DataParallel.new(model_with_loss, device_ids: [0, 1])
